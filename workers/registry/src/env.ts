export interface Env {
  ...
  CATALOG_SKIP_UNCHANGED?: string;
  CATALOG_RESCAN_TTL_HOURS?: string;
  CATALOG_SCAN_MAX_DURATION_MS?: string;
  CATALOG_SCAN_MAX_BATCHES?: string;
  CATALOG_FETCH_README?: string;
  CATALOG_TAGGING_ENABLED?: string;
  CATALOG_TAGGING_BATCH_SIZE?: string;
  CATALOG_TAGGING_DELAY_MS?: string;
}
