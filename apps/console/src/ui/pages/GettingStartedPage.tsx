    ...
    return (
        <div className="max-w-3xl mx-auto space-y-12">
            ...
            <section className="space-y-6">
                ...
                <p className="text-sm text-brand-forest/60 font-medium px-2">
                    Skild supports Claude, Codex, Cursor, Windsurf, OpenCode, Copilot, Antigravity, and Agents. Use <code className="bg-brand-forest/5 px-2 py-0.5 rounded-full text-brand-forest font-bold">-t windsurf</code> to target other platforms.
                </p>
            </section>
